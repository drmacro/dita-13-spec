...
<!--                                                               -->
<!-- ============================================================= -->
<!--                    1.3 DRAFT for test - Machine Industry Subcommittee                           -->
<!-- ============================================================= -->
...
<!--    2009.03.25 CHK: Adding quantity element and child element   -->
<!-- ============================================================= -->
...
<!-- ============================================================= -->
<!--                    NEW DITA 1.3 proposed elements - start                                             -->
<!-- ============================================================= -->

<!--                    LONG NAME: Quantity                          -->
<!ENTITY % quantity.content
                       "(%qtygrp;)*"
>
             ...
             "qtytype
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT quantity    %quantity.content;>
<!ATTLIST quantity    %quantity.attributes;>

<!--                    LONG NAME: Quantity Group                          -->
<!ENTITY % qtygrp.content
                       "(((%qtyvalue;)+,
						 (%qtytolerance;)*) | 
						 (%qtytolerance;)+)"
>
<!ENTITY % qtygrp.attributes
             "qtytype
						CDATA
                                  #IMPLIED
              qtyuom
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT qtygrp    %qtygrp.content;>
<!ATTLIST qtygrp    %qtygrp.attributes;>

<!--                    LONG NAME: Quantity Value                          -->
<!ENTITY % qtyvalue.content
                       "(%quantity.cnt; |
                         %text;)*"
>
<!ENTITY % qtyvalue.attributes
             "qtyuom
						CDATA
                                  #IMPLIED
              system-of-measurement 
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT qtyvalue    %qtyvalue.content;>
<!ATTLIST qtyvalue    %qtyvalue.attributes;>


<!--                    LONG NAME: Quantity Tolerance                          -->
<!ENTITY % qtytolerance.content
                       "(%quantity.cnt; |
                         %text;)*"
>
<!ENTITY % qtytolerance.attributes
             'qtytoltype
						 (plus |
                         minus | 
                         plusorminus)
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED'
>
<!ELEMENT qtytolerance    %qtytolerance.content;>
<!ATTLIST qtytolerance    %qtytolerance.attributes;>

<!-- ============================================================= -->
<!--                    NEW DITA 1.3 proposed elements    - end                                           -->
<!-- ============================================================= -->
...
<!ATTLIST quantity         %global-atts;  class CDATA "- topic/quantity "          >
<!ATTLIST qtygrp         %global-atts;  class CDATA "- topic/qtygrp "          >
<!ATTLIST qtyvalue         %global-atts;  class CDATA "- topic/qvalue "          >
<!ATTLIST qtytolerance         %global-atts;  class CDATA "- topic/qtytolerance "          >
