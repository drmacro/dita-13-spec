...
<!-- April 2012: WEK:  
     - Added (%lcInteractionlabel;)* where title was allowed
       in interactions
     - Changed %ph.cnt; to %div.cnt; throughout
...
<!-- NOTE: base type imagemap has a restricted content
           model that does not allow <p> where it 
           would be required in order to allow lcInteractionLabel
           to occur. 
  -->
...
<!-- WEK: Added %forgeign; to allow e.g. inline MathML and SVN --> 									
